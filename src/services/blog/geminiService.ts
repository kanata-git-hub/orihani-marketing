...
[마무리 규칙]
결론부에서 '~하지 마세요', '~를 경험해보세요' 같은 감정적 호소나 청유형 마케팅 멘트를 절대 사용하지 마세요. 
대신 철저히 3인칭 전문가의 객관적인 조언 톤으로 담백하게 결론을 내리세요. 이때 '~치료 접근이 필요합니다', '~원인이 존재합니다' 같은 과하게 딱딱한 번역투 대신, '~치료가 필요합니다', '~원인이 있습니다' 등 자연스럽고 명료한 우리말 서술어를 사용하세요.
