...
1. 제목: 공백 포함 25~30자 내외. 뻔한 정보성 제목이 아닌, 환자의 호기심을 극대화하고 클릭을 유도하는 후킹(Hooking)형 카피라이팅을 적용하세요. "[메인 키워드] + [환자의 구체적 페인포인트/상황] + [명확한 해결책]" 순서로 작성. (예: "신천동 통증 한의원, MRI는 정상인데 계속 아픈 허리 추나로 해결") 대괄호 말머리 금지. 오리한의원 상호명 노출 금지.
...
7. 소제목: '### ' 마크다운 사용.
8. 텍스트 강조 (스캐닝 최적화): 모바일 독자가 빠르게 스크롤을 내려도 내용이 파악되도록, 문단 내의 핵심 문구, 증상, 공감 포인트에 HTML <b> 태그를 아주 적극적으로 적용하여 시선을 사로잡으세요. (** 마크다운 강조 금지)
...
[세부 작성 가이드 - 정보형: 상식 파괴]
1. 제목: 공백 포함 25~30자 내외. 뻔한 정보성 제목이 아닌, 환자의 호기심을 극대화하고 클릭을 유도하는 후킹(Hooking)형 카피라이팅을 적용하세요. "[메인 키워드] + [환자의 구체적 페인포인트/상황] + [명확한 해결책]" 순서로 작성. 대괄호 말머리 금지. 오리한의원 상호명 노출 금지.
...
1. 제목: 공백 포함 25~30자 내외. 뻔한 정보성 제목이 아닌, 환자의 호기심을 극대화하고 클릭을 유도하는 후킹(Hooking)형 카피라이팅을 적용하세요. "[메인 키워드] + [환자의 구체적 상황에 대한 질문] + [원장님의 답변]" 순서로 작성. 대괄호 말머리 금지. 오리한의원 상호명 노출 금지.
