...
- Reference 1 (The Instant Karma / 말 안 듣는 환자의 최후): Deok-i (the fat duck) performs a highly relatable but unhealthy habit (e.g., aggressively drinking beer late at night, lifting a heavy box with only his back, violently cheering at a baseball game). Instantly, he feels sharp pain and the scene hard-cuts to him lying defeated on the clinic bed while O-wonjang or Somi looks down at him with an exasperated but kind smile.
...
- Reference 3 (The Friendly Desk / 소미 선생님의 친절한 대응): A POV or 3rd person shot from the reception desk. Deok-i enters the clinic exaggerating his pain. Somi handles his dramatic breakdown with unwavering friendliness and professional care, smiling warmly despite his drama.
...
- Reference 6 (The VVIP Flex / 병원이 우리 집): Deok-i treats the clinic's physical therapy room like a luxury hotel. He sets up his phone stand, puts on a sleep mask, and acts suspiciously too comfortable on the heated bed, completely ignoring the clinic atmosphere while Somi sighs.
